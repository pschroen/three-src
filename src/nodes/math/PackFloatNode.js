 ...
 * @returns {Node}
 */
export const packSnorm2x16 = nodeProxyIntent( PackFloatNode, 'snorm' ).setParameterLength( 1 );
 ...
 * @returns {Node}
 */
export const packUnorm2x16 = nodeProxyIntent( PackFloatNode, 'unorm' ).setParameterLength( 1 );
 ...
 * @returns {Node}
 */
export const packHalf2x16 = nodeProxyIntent( PackFloatNode, 'float16' ).setParameterLength( 1 );
