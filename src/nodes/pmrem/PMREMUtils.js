...
const radicalInverse_VdC = Fn( ( [ bits_immutable ] ) => {
...
const importanceSampleGGX_VNDF = Fn( ( [ Xi, V_immutable, roughness_immutable ] ) => {
...
export const ggxConvolution = Fn( ( { roughness, mipInt, envMap, N_immutable, GGX_SAMPLES, CUBEUV_TEXEL_WIDTH, CUBEUV_TEXEL_HEIGHT, CUBEUV_MAX_MIP } ) => {
