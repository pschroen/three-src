 ...
 * @returns {RemapNode}
 */
export const remap = nodeProxy( RemapNode, null, null, { doClamp: false } ).setParameterLength( 3, 5 );
 ...
 * @returns {RemapNode}
 */
export const remapClamp = nodeProxy( RemapNode ).setParameterLength( 3, 5 );
