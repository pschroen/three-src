 ...
 * @type {Node<vec3>}
 */
export const bitangentGeometry = getBitangent( normalGeometry.cross( tangentGeometry ), 'v_bitangentGeometry' ).normalize().toVar( 'bitangentGeometry' );
 ...
 * @type {Node<vec3>}
 */
export const bitangentLocal = getBitangent( normalLocal.cross( tangentLocal ), 'v_bitangentLocal' ).normalize().toVar( 'bitangentLocal' );
 ...
 * @type {Node<vec3>}
 */
export const bitangentWorld = getBitangent( normalWorld.cross( tangentWorld ), 'v_bitangentWorld' ).normalize().toVar( 'bitangentWorld' );
 ...
 * @type {Node<vec3>}
 */
export const transformedBitangentView = getBitangent( transformedNormalView.cross( transformedTangentView ), 'v_transformedBitangentView' ).normalize().toVar( 'transformedBitangentView' );
